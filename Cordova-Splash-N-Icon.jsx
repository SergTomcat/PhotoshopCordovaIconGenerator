...
if (sPicPath != undefined)
{
	...
	var aIconInfo = [
		...
		["/icons/ios/", "icon-20.png", 20,20,"png"],
		["/icons/ios/", "icon-44@2x.png", 88,88,"png"],
		["/icons/ios/", "icon-24@2x.png", 48,48,"png"],
		["/icons/ios/", "icon-27.5@2x.png", 55,55,"png"],
		["/icons/ios/", "icon-86@2x.png", 172,172,"png"],
		["/icons/ios/", "icon-98@2x.png", 196,196,"png"],
		["/icons/ios/", "icon-108@2x.png", 216,216,"png"],
		["/icons/ios/", "icon-35@2x.png", 70,70,"png"],
		["/icons/ios/", "icon-28@2x.png", 56,56,"png"],
		["/icons/ios/", "icon-28@3x.png", 84,84,"png"],
		["/icons/ios/", "icon-18@2x.png", 36,36,"png"],
		["/icons/ios/", "icon-18@3x.png", 54,54,"png"],
		...
		["/icons/ios/", "icon-small@3x.png", 87,87,"png"],
